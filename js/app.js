(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".partners__slider", {
                modules: [ Autoplay, Keyboard, Mousewheel, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                spaceBetween: 30,
            ...
            new core(".slider-review", {
                modules: [ Autoplay, Keyboard, Mousewheel, Navigation, Lazy, Pagination ],
                slidesPerView: 1,
                spaceBetween: 0,
                autoHeight: false,
                speed: 800,
    ...
    function w3AddClass(element, name) {
        ...
        arr2 = name.split(" ");
        for (i = 0; i < arr2.length; i++) if (-1 == arr1.indexOf(arr2[i])) element.className += " " + arr2[i];
    }
